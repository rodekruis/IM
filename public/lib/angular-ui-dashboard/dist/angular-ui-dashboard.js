      ...
      link: function (scope, element) {
        ...
        scope.grabResizer = function (e) {
          ...
          var mousemove = function (e) {
            ...
            var pixelYChange = curY - initY;
            var newWidth = pixelWidth + pixelChange;
            var newHeight = pixelHeight + pixelYChange;
          ...
          var mouseup = function (e) {
            ...
            var unitYChange = Math.round(pixelYChange * transformMultiplier * 100) / 100;

            // add to initial unit width
            var newWidth = unitWidth * 1 + unitChange;
            var newHeight = unitHeight * 1 + unitYChange;
...
angular.module('ui.dashboard')
  .factory('WidgetModel', function () {
    ...
    function WidgetModel(Class, overrides) {
      ...
      this.style = this.style || { width: '33%', height: '20%' };
